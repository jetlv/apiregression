...
describe('getProductSumPrice', function () {
    ...
    describe('getProductSumPrice - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/products/getProductSumPrice.htm?productIds=509945,536815&languageCode=cn-cn&websiteId=9'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
