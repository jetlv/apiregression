...
describe('createCouponForMemberByOrdersId', function () {
    ...
    describe('createCouponForMemberByOrdersId - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/member/coupon/createCouponForMemberByOrdersId.htm?ordersId=1008'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
