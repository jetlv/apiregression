...
describe('findProductsIdNotFittedCrearenceRule', function () {
    ...
    describe('findProductsIdNotFittedCrearenceRule - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/products/findProductsIdNotFittedCrearenceRule.htm?productIds=12312,1231,1698,4487'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
