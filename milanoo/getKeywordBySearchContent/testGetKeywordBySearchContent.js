...
describe('getKeywordBySearchContent', function () {
    ...
    describe('getKeywordBySearchContent - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/keyword/getKeywordBySearchContent.htm?websiteId=1&languageCode=en-uk&searchContent=wedding&returnNum=10'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
