...
describe('getNewUserCouponsInfo', function () {
    ...
    describe('getNewUserCouponsInfo - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/member/member/getNewUserCouponsInfo.htm?websiteId=1&languageCode=en-uk&priceUnit=USD'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
