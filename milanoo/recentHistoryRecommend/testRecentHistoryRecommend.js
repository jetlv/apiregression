...
describe('recentHistoryRecommend', function () {
    ...
    describe('recentHistoryRecommend - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/productRecommend/recentHistoryRecommend.htm?productId=243180&recentHistoryPid=389945,331306,15459,229214,125622,386371&returnRelatedNum=12&languageCode=en-uk&websiteIdLastView=1'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
