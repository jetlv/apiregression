...
describe('urlAccessRecord', function () {
    ...
    describe('urlAccessRecord - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/promotion/urlAccessRecord.htm?promotionType=test&linkAddressUrl=www.milanoo.com/sale&refererAddressURL=www.milanoo.com&refererAddressURLmd5=SEAFEAWGASEFAFADSFA&websiteId=1'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
