...
describe('listCategoryResultComment', function () {
    ...
    describe('listCategoryResultComment - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/productComment/listCategoryResultComment.htm?websiteId=1&languageCode=en-uk&categoryId=391&pageNo=1&pageSize=12'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
