...
describe('getProblemsByIds', function () {
    ...
    describe('getProblemsByIds - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/member/help/getProblemsByIds.htm?langCode=en-uk&websiteId=1&problemIds=1261,1295'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
