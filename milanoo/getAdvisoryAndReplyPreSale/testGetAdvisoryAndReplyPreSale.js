...
describe('getAdvisoryAndReplyPreSale', function () {
    ...
    describe('getAdvisoryAndReplyPreSale - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/member/advisory/getAdvisoryAndReplyPreSale.htm?id=21343&langCode=en-uk&memberId=15497'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
