...
describe('productsCategoryNav', function () {
    ...
    describe('productsCategoryNav - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/productCategory/productsCategoryNav.htm?categoryId=391&langCode=en-uk&websiteId=1&activate=0'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
