...
describe('findPromotionFeatrue', function () {
    ...
    describe('findPromotionFeatrue - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/promotion/findPromotionFeatrue.htm?returnNum=5&languageCode=en-uk&websiteId=1'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
