...
describe('productDetails', function () {
    ...
    describe('productDetails - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/products/productDetails.htm?websiteIdLastView=1&languageCode=en-uk&productId=210072&websiteId=1&isGift='
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
