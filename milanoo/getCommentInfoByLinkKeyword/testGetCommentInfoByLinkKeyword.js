...
describe('getCommentInfoByLinkKeyword', function () {
    ...
    describe('getCommentInfoByLinkKeyword - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/productComment/getCommentInfoByLinkKeyword.htm?keyword=test&languageCode=en-uk&websiteId=1&pageNo=1&pageSize=36'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
