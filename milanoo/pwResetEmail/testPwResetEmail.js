...
describe('pwResetEmail', function () {
    ...
    describe('pwResetEmail - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/member/member/pwResetEmail.htm?email=test@milanoo.com&websiteId=1&lang=en-uk&rootUrl=www.milanoo.com'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
