...
describe('getKeywordByLetter', function () {
    ...
    describe('getKeywordByLetter - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/keyword/getKeywordByLetter.htm?websiteId=1&languageCode=en-uk&firstLetter=A&pageSize=12&pageNo=1'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
