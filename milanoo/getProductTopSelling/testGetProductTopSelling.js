...
describe('getProductTopSelling', function () {
    ...
    describe('getProductTopSelling - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/products/getProductTopSelling.htm?websiteId=1&categoryId=391&languageCode=en-uk&reutrnNum=10'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
