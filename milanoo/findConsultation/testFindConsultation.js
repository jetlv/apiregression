...
describe('findConsultation', function () {
    ...
    describe('findConsultation - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/member/advisory/findConsultation.htm?websiteId=1&languageCode=en-uk&pid=0&classKey=key&pageNo=1&pageSize=12'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
