...
describe('getQAPage', function () {
    ...
    describe('getQAPage - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/productQA/getQAPage.htm?languageCode=fr-fr&productId=7805&websiteId=1&typeId=0&pageNo=1&pageSize=12'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
