...
describe('getSalesProperties', function () {

    describe('getSalesProperties - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/products/getSalesProperties.htm?productId=2917&isLinkage=1&websiteId=1&languageCode=en-uk'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
