...
describe('topQueryRecommend', function () {
    ...
    describe('topQueryRecommend - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/productRecommend/topQueryRecommend.htm?productId=243180&searchContent=1&pageSize=36&pageNo=1&languageCode=en-uk&websiteIdLastView=1'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
