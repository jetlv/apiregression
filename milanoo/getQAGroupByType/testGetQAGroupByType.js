...
describe('getQAGroupByType', function () {
    ...
    describe('getQAGroupByType - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/productQA/getQAGroupByType.htm?languageCode=en-uk&productId=7805&websiteId=1&typeId=0&pageNo=1&pageSize=24'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
