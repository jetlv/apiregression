...
describe('createCouponByRuleId', function () {
    ...
    describe('createCouponByRuleId - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/member/coupon/createCouponByRuleId.htm?id=1&memberId=1&email=&isSendEmail=&createMax=5&langCode=en-uk&websiteId=1'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
