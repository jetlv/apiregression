...
describe('findFlashSaleProducts', function () {

    describe('findFlashSaleProducts - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/promotion/findFlashSaleProducts.htm?featureId=&featureName=skin_60&languageCode=en-uk&websiteId=1&categoryNum=6&productNum=4'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
