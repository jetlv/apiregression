...
describe('getProductsCategory', function () {
    ...
    describe('getProductsCategory - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/products/getProductsCategory.htm?parentCategoryId=0&languageCode=en-uk&returnChildNum= -1:-1:-1&activate=0&websiteIdLastView=1'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
