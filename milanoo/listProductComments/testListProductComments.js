...
describe('listProductComments', function () {

    describe('listProductComments - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/productComment/listProductComments.htm?categoryId=829&productIds=334328&websiteId=1&languageCode=en-uk&pageNo=1&pageSize=60'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
