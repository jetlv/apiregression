...
describe('upadteProductsCategoryLang', function () {
    ...
    describe('upadteProductsCategoryLang - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/productCategory/upadteProductsCategoryLang.htm?categoryId=391&lang=en-uk&keywordDesc=wedding'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
