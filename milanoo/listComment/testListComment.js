...
describe('listComment', function () {
    ...
    describe('listComment - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/productComment/listComment.htm?pc.productId=243180&pc.websiteId=1&pc.languageCode=en-uk&pc.pageSize=3&pc.pageNo=1&pc.sortObject=default'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
