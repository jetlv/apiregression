...
describe('modifyMemberInfo', function () {

    describe('modifyMemberInfo - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/member/member/modifyMemberInfo.htm?id=2105243&contact=lujia&sex=woman&birthDay=19890808&state=china&urbanAreas=sichuan&city=chengdu&zip=610000&contactAddr=software&contactMobile=15864675644&companyName=milanoo'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
