...
describe('editRmaProduct', function () {
    ...
    describe('editRmaProduct - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/member/rma/editRmaProduct.htm?p.id=16&p.rmaId=10010&p.orderId=1063262&type=1'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
