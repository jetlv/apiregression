...
describe('homeRecommendForApp', function () {

    describe('homeRecommendForApp - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/productRecommend/homeRecommendForApp.htm?memberId=123&cookieId=stes1&websiteId=1&languageCode=en-uk&returnNum=20'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
