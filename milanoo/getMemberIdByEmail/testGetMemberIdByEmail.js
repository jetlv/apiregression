...
describe('getMemberIdByEmail', function () {
    ...
    describe('getMemberIdByEmail - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/member/member/getMemberIdByEmail.htm?email=171user@milanoo.com&websiteId=1'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
