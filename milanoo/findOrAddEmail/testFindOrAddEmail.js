...
describe('findOrAddEmail', function () {
    ...
    describe('findOrAddEmail - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/email/findOrAddEmail.htm?email=milaoo_test@milanoo.com&langCode=en-uk&websiteId=1&firstName=milanoo_test'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
