...
describe('getOrdersCountByMemberId', function () {
    ...
    describe('getOrdersCountByMemberId - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/member/order/getOrdersCountByMemberId.htm?memberId=2924077&websiteId=1'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
