...
describe('getFavorites', function () {
    ...
    describe('getFavorites - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/member/favorites/getFavorites.htm?memberId=2105243&languageCode=en-uk&websiteId=3&searchContent=&ordersEstate=&pageNo=1&pageSize=8'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
