...
describe('getMemberAddressBook', function () {
    ...
    describe('getMemberAddressBook - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/member/member/getMemberAddressBook.htm?memberId=3214999&languageCode=en-uk'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
