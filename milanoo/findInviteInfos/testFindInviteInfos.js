...
describe('findInviteInfos', function () {
    ...
    describe('findInviteInfos - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/member/member/findInviteInfos.htm?memberId=123&pageNo=1&pageSize=20&websiteId=1&languageCode=en-uk'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
