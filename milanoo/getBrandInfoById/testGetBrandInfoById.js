...
describe('getBrandInfoById', function () {
    ...
    describe('getBrandInfoById - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/brand/getBrandInfoById.htm?websiteId=3&languageCode=en-uk&brandId=108'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
