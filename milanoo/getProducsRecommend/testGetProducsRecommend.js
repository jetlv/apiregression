...
describe('getProducsRecommend', function () {
    ...
    describe('getProducsRecommend - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/products/getProducsRecommend.htm?languageCode=en-uk&productNum=4&crowd=&websiteId=1&websiteIdLastView=1'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
