...
describe('getCouponsByProductId', function () {
    ...
    describe('getCouponsByProductId - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/member/coupon/getCouponsByProductId.htm?productId=123&websiteId=1&languageCode=en-uk&deviceType=1'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
