...
//
//     describe('pwReset - 基本验证', function () {
//         //上下文
//         let ctx = {};
//
//         /** 该接口测试前置操作*/
...
//         it('general', async() => {
//             let generalReq = () => {
//                 let fullPath = 'http://192.168.11.67:8080/member/member/pwReset.htm?url=changewordset&websiteId=1&pwNew=123456&langCode=en-uk'
//                 let reqOpt = {
//                     uri: fullPath,
//                     method: 'GET',
//                     gzip: true,
