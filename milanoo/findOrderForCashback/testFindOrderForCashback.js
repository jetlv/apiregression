...
describe('findOrderForCashback', function () {
    ...
    describe('findOrderForCashback - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/member/cashback/findOrderForCashback.htm?memberId=3214999&langCode=en-uk&websiteId=1'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
