...
describe('statisticsBrandByCategory', function () {
    ...
    describe('statisticsBrandByCategory - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/brand/statisticsBrandByCategory.htm?websiteId=3&languageCode=en-uk&categoryId=0'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
