...
describe('remove', function () {
    ...
    describe('remove - 基本验证', function () {
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/productViewHistory/remove.htm?cookieId=cc02db9d60a21373c63379ed67f74dca&memberId=&websiteId=1&productIds=1,2,3'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
