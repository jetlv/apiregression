...
describe('getOrders', function () {
    ...
    describe('getOrders - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/member/order/getOrders.htm?memberId=2105243&languageCode=en-uk&websiteId=1&websiteIdFilter=&ordersEstate=0&ordersPay=&loadProducts=1&pageNo=1&pageSize=12'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
