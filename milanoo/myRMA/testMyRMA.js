...
describe('myRMA', function () {
    ...
    describe('myRMA - 基本验证', function () {
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/member/rma/myRMA.htm?websiteIdLastView=1&memberId=2105245&languageCode=en-uk&websiteId=4&rmaStatus='
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
