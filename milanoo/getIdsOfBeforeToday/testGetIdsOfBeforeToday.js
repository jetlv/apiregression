...
describe('getIdsOfBeforeToday', function () {

    describe('getIdsOfBeforeToday - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/products/getIdsOfBeforeToday.htm?todayNum=60000&websiteId=1&languageCode=en-uk'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
