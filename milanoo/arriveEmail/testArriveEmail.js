...
describe('arriveEmail', function () {
    ...
    describe('arriveEmail - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/products/arriveEmail.htm?productId=2917&languageCode=en-uk&email=test@milanoo&memberId=123'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
