...
describe('getProblemsByProductId', function () {
    ...
    describe('getProblemsByProductId - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/member/help/getProblemsByProductId.htm?langCode=en-uk&websiteId=1&productId=12'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
