...
describe('getOrdersByMemberId', function () {

    describe('getOrdersByMemberId - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/member/order/getOrdersByMemberId.htm?websiteIdLastView=1&memberId=2105243&searchContent=&ordersEstate=&type=&pageNo=1&pageSize=100000&languageCode=en-uk&lastMonth=&websiteIdFilter=&websiteId=1'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
