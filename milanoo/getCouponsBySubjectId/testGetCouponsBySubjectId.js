...
describe('getCouponsBySubjectId', function () {
    ...
    describe('getCouponsBySubjectId - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/member/coupon/getCouponsBySubjectId.htm?subjectId=123&websiteId=9&languageCode=cn-cn&deviceType=1'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
