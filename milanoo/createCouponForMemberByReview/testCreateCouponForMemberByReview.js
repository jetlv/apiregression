...
describe('createCouponForMemberByReview', function () {
    ...
    describe('createCouponForMemberByReview - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/member/coupon/createCouponForMemberByReview.htm?commentId=518089&memberId=20&langageCode=en-uk&websiteId=1&memberMail=123456@123.com'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
