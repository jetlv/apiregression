...
describe('queryBrandList', function () {
    ...
    describe('queryBrandList - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/brand/queryBrandList.htm?websiteId=3&languageCode=en-uk&pageSize=10&pageNo=1'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
