...
describe('queryRmaProductNum', function () {
    ...
    describe('queryRmaProductNum - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/member/rma/queryRmaProductNum.htm?beginDate=2014-04-01&endDate=2014-05-15 13:54:42'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
