...
describe('reviewInfo', function () {
    ...
    describe('reviewInfo - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/member/comment/reviewInfo.htm?reviewId=1&memberId=2105245&languageCode=en-uk&langCodeTo=en-uk'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
