...
describe('getRecommendKeyword', function () {
    ...
    describe('getRecommendKeyword - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/keyword/getRecommendKeyword.htm?categoryId=391&languageCode=en-uk'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
