...
describe('queryCustomProductInput', function () {

    describe('queryCustomProductInput - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/products/queryCustomProductInput.htm?orderId=2'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
