...
describe('getAdvisoryAndReplyAfterSale', function () {
    ...
    describe('getAdvisoryAndReplyAfterSale - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/member/advisory/getAdvisoryAndReplyAfterSale.htm?id=5815&langCode=en-uk&memberId=56187'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
