...
describe('addCashback', function () {
    ...
    describe('addCashback - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/member/cashback/addCashback.htm?c.memberId=54115&c.langCode=en-uk&c.websiteId=2&c.orderId=5615'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
