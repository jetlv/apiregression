...
//
//     describe('orderForRMA - 基本验证', function () {
//         //上下文
//         let ctx = {};
//
//         /** 该接口测试前置操作*/
...
//         it('general', async() => {
//             let generalReq = () => {
//                 let fullPath = 'http://192.168.11.67:8080/member/rma/orderForRMA.htm?websiteIdLastView=1&memberId=2105245&languageCode=en-uk&websiteId=1'
//                 let reqOpt = {
//                     uri: fullPath,
//                     method: 'GET',
//                     gzip: true,
