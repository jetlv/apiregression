...
describe('findPromotion', function () {
    ...
    describe('findPromotion - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/promotion/findPromotion.htm?libkey=DailyMadness&rows=5&rowNum=5&languageCode=en-uk&websiteId=1'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
