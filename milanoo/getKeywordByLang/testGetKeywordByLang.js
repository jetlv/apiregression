...
describe('getKeywordByLang', function () {
    ...
    describe('getKeywordByLang - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/keyword/getKeywordByLang.htm?returnNum=10&languageCode=en-uk&categoryId=&websiteId=1&websiteIdLastView=1'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
