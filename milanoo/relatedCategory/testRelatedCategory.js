...
describe('relatedCategory', function () {
    ...
    describe('relatedCategory - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/productCategory/relatedCategory.htm?websiteId=1&langCode=en-uk&categoryId=392&returnNum=5'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
