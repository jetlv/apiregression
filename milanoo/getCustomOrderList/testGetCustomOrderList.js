...
describe('getCustomOrderList', function () {

    describe('getCustomOrderList - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/products/getCustomOrderList.htm?languageId=2&languageCode=en-uk&pageNo=1&pageSize=20'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
