...
describe('getProductsCategoryForSEO', function () {
    ...
    describe('getProductsCategoryForSEO - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/products/getProductsCategoryForSEO.htm?languageCode=en-uk&categoryId=391&websiteId=1&websiteIdLastView=1'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
