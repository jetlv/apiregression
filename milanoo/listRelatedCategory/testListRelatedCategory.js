...
describe('listRelatedCategory', function () {
    ...
    describe('listRelatedCategory - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/productComment/listRelatedCategory.htm?languageCode=en-uk&categoryId=398&websiteId=1'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
