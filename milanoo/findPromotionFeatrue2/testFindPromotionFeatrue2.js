...
describe('findPromotionFeatrue2', function () {
    ...
    describe('findPromotionFeatrue2 - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/promotion/findPromotionFeatrue2.htm?languageCode=en-uk&pageNo=1&pageSize=12&websiteId=2'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
