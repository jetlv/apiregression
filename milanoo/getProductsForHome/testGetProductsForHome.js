...
describe('getProductsForHome', function () {

    describe('getProductsForHome - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/products/getProductsForHome.htm?type=3&websiteId=3&languageCode=en-uk&productNum=10&deviceType=1'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
