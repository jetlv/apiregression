...
describe('modelList', function () {
    ...
    describe('modelList - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/model/modelList.htm?langCode=en-uk&pageNo=1&pageSize=16&sort=productNum&websiteIdLastView=1'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
