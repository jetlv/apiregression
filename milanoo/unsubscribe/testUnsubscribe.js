...
describe('unsubscribe', function () {
    ...
    describe('unsubscribe - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/email/unsubscribe.htm?email=milanoo_test@milanoo.com&langCode=pt-pt&websiteId=2'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
