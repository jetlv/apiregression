...
describe('getCoupons', function () {
    ...
    describe('getCoupons - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/member/coupon/getCoupons.htm?websiteIdLastView=1&languageCode=en-uk&memberId=2105243&websiteId=4'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
