...
describe('mayPurchaseRecommend', function () {
    ...
    describe('mayPurchaseRecommend - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/productRecommend/mayPurchaseRecommend.htm?productId=243180&returnNum=12&languageCode=en-uk&websiteId=1'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
