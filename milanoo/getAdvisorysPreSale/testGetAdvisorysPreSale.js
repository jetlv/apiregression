...
describe('getAdvisorysPreSale', function () {
    ...
    describe('getAdvisorysPreSale - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/member/advisory/getAdvisorysPreSale.htm?memberId=44441&langCode=en-uk&websiteId=1&days=7&pageNo=1&pageSize=36'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
