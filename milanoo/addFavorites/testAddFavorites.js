...
describe('addFavorites', function () {
    ...
    describe('addFavorites - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/member/favorites/addFavorites.htm?memberId=2105243&productId=218142&websiteId=1'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
