...
describe('modifyMemberPW', function () {
    ...
    describe('modifyMemberPW - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/member/member/modifyMemberPW.htm?memberId=2105243&oldPW=123456&newPW=11111&langCode=en-uk'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
