...
describe('bindOrderForCustomOrder', function () {

    describe('bindOrderForCustomOrder - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/products/bindOrderForCustomOrder.htm?custom={"id":7,"bindOrderId":5}'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
