...
//
//     describe('inviteMember - 基本验证', function () {
//         //上下文
//         let ctx = {};
//
//         /** 该接口测试前置操作*/
...
//         it('general', async() => {
//             let generalReq = () => {
//                 let fullPath = 'http://192.168.11.67:8080/member/member/inviteMember.htm?in.memberId=123&in.nickname=chepooo&in.emails=abc@milanoo.com,sbd@sina.com&in.websiteId=1&in.languageCode=en-uk'
//                 let reqOpt = {
//                     uri: fullPath,
//                     method: 'GET',
//                     gzip: true,
