...
describe('getProductsCategorySearch', function () {

    describe('getProductsCategorySearch - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/products/products/getProductsCategorySearch.htm?pcs.categoryId=0&pcs.languageCode=en-uk&pcs.websiteId=1'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
