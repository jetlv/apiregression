...
describe('getAdvisorysAfterSale', function () {
    ...
    describe('getAdvisorysAfterSale - 基本验证', function () {
        //上下文
        let ctx = {};
        ...
        it('general', async() => {
            let generalReq = () => {
                let fullPath = 'http://192.168.11.67:8080/member/advisory/getAdvisorysAfterSale.htm?memberId=44441&languageCode=en-uk&websiteId=1&days=7&pageNo=1&pageSize=36'
                let reqOpt = {
                    uri: fullPath,
                    method: 'GET',
                    gzip: true,
